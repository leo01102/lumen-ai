...
# NOTE: marcamos este módulo como obsoleto o no? lo eliminamos? porque ahora hacemos
#       el análisis de emociones faciales desde el frontend con face-api.js
"""
...
def analyze_frame_emotions(detector, frame_np):
    ...
    try:
        ...
        # es un error no crítico, por lo que usamos 'warning'
